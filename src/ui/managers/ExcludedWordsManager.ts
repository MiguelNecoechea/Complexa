// POS Categories definition (imported from app.ts)
...
/**
 * Excluded Words Manager Class
 * Manages the display and interaction with excluded words,
 * including loading, rendering, and removal functionality.
 */
export class ExcludedWordsManager {
